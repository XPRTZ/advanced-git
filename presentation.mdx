...
If the dependencies get really complex or the project is big, managing the dependencies through Git is often not the best solution. Try real package manager like nuget, npm, pip, ...
